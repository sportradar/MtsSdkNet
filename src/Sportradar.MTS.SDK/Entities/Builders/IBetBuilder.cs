...
namespace Sportradar.MTS.SDK.Entities.Builders
{
    ...
    public interface IBetBuilder
    {
        ...
        IBetBuilder SetBetBonus(long value, BetBonusMode betBonusMode = BetBonusMode.All, BetBonusType betBonusType = BetBonusType.Total, BetBonusDescription? description = null, BetBonusPaidAs? paidAs = null);
