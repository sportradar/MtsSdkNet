...
namespace Sportradar.MTS.SDK.API.Internal.RabbitMq
{
    ...
    internal class ConfiguredConnectionFactory : ConnectionFactory
    {
        ...
        private static readonly ISet<string> TLS_VERIFICATION_IGNORE_LIST = new HashSet<string> { "91.201.213.134", "91.201.212.86", "integration-mts.betradar.com", "tradinggate.betradar.com" };
